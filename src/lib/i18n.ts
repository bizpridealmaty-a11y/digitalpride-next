...
export const ui = {
    ru: {
        ...
        heroHeadline: 'Маркетинговое агентство полного цикла',
        heroAccent: 'в Алматы',
        heroDescription: 'Маркетинг, который приносит прибыль. Строим предсказуемый поток клиентов для бизнеса в Алматы и по всему Казахстану — не просто льём трафик.',
    ...
    kk: {
        ...
        heroHeadline: 'Толық циклді маркетинг агенттігі',
        heroAccent: 'Алматыда',
        heroDescription: 'Маркетинг пайда әкеледі. Алматы мен бүкіл Қазақстандағы бизнес үшін болжамды клиент ағынын құрамыз — біз тек трафик құймаймыз.',
