    ...
    return (
        <ServicePageTemplate
            ...
            features={[
                ...
                { title: 'Интеграция с CRM', description: 'AmoCRM, 1С, кастомные системы — все заявки автоматически попадают в CRM с присвоением статуса.', icon: icon('M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z') },
            ...
            faq={[
                ...
                { q: 'Какие инструменты используете?', a: 'AmoCRM, 1С, SendPulse, ManyChat, Telegram-боты и кастомные решения под задачу клиента.' },
            ]}
            seoContent={[
                {
