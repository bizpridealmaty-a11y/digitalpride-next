...
const socials = [
    { name: 'Instagram', href: 'https://www.instagram.com/digitalpride.kz/', icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z" /></svg> },
    { name: 'Telegram', href: 'https://t.me/timoshevskij', icon: <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z" /></svg> },
];
    ...
    const contactInfo = [
        {
            ...
            title: isKk ? 'Мекенжай' : 'Адрес',
            text: isKk ? 'Алматы қ., Бұхар-Жырау даңғылы, 33, 3 қабат, 13 студия' : 'г. Алматы, проспект Бухар-Жирау, 33, 3 этаж, студия 13',
            href: 'https://go.2gis.com/dw4lA',
        },
        {
            icon: (
        ...
        },
        {
            ...
            title: 'WhatsApp',
            text: isKk ? 'WhatsApp-қа жазу' : 'Написать в WhatsApp',
                ...
                <div className="container mx-auto px-4 max-w-6xl">
                    ...
                    <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
                        ...
                        <h1 className="text-4xl md:text-6xl font-extrabold text-black mb-6 tracking-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                            {isKk ? 'Байланыс' : 'Контакты'} <span className="text-red-600">Digital Pride</span>
                        </h1>
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            {isKk
                                ? 'Біз әрқашан байланыстамыз. Қоңырау шалыңыз, жазыңыз немесе кеңсеге келіңіз — жобаңызды талқылап, ең жақсы шешімді табамыз.'
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                        ...
                        >
                            <div>
                                <h3 className="text-2xl font-bold mb-4">{isKk ? 'Жобаңызды талқылаймыз ба?' : 'Обсудим ваш проект?'}</h3>
                                <p className="text-gray-400 mb-6 text-sm leading-relaxed">
                                    {isKk
                                        ? 'Қызметтер, бағалар және ынтымақтастық бойынша барлық сұрақтар бойынша кез келген ыңғайлы уақытта хабарласа аласыз. 15 минутта жауап береміз.'
                                ...
                                <div className="space-y-3 mb-8">
                                    <div className="flex items-center gap-3 text-sm">
                                        ...
                                        <span className="text-gray-300">{isKk ? 'Тегін консультация' : 'Бесплатная консультация'}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-sm">
                                        <span className="text-red-500">✓</span>
                                        <span className="text-gray-300">{isKk ? '15 минутта жауап' : 'Ответ в течение 15 минут'}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-sm">
                                        <span className="text-red-500">✓</span>
                                        <span className="text-gray-300">{isKk ? 'Жеке есептеу' : 'Индивидуальный расчёт'}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                >
                                    {isKk ? 'WhatsApp-қа жазу →' : 'Написать в WhatsApp →'}
                                </a>
                                <a
                                    href="tel:+77070357777"
                                ...
                                >
                                    {isKk ? 'Қоңырау шалу: +7 (707) 035-77-77' : 'Позвонить: +7 (707) 035-77-77'}
                                </a>
                            </div>
                        </motion.div>
                    </div>
