...
export const metadata: Metadata = {
    ...
    description: 'Кейс: таргет лазерная эпиляция в Алматы. 679 заявок в WhatsApp за $1,29. Снизили стоимость заявки в Instagram в 3 раза. Настройка рекламы WhatsApp бизнес, реальные цифры и ROMI 51%.',
