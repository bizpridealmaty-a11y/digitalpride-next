            ...
            <main className="bg-white pt-32 pb-24">
                ...
                <div className="container mx-auto px-4 max-w-7xl mb-16">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-12 justify-items-center">
                        {[
                            { href: '/cases/investbridge/', img: '/images/cases/investbridge/hero-mobile.jpg', scroll: undefined as string | undefined, scrollH: 0, accent: '#C9A24B', title: 'Инвестфорум Италия × Казахстан', desc: 'Официальный сайт форума: 4 языка, программа, участники, заявки.' },
                            { href: '/cases/art-cleaning/', img: '/images/cases/art-cleaning/hero-mobile.jpg', scroll: '/images/cases/art-cleaning/scroll.jpg', scrollH: 2162, accent: '#28C5C8', title: 'ART Cleaning — B2B-клининг', desc: 'Сайт-продавец: технология, калькулятор, кейсы, WhatsApp.' },
                            { href: '/cases/ezhovik/', img: '/images/cases/ezhovik/hero-mobile.jpg', scroll: '/images/cases/ezhovik/scroll.jpg', scrollH: 1643, accent: '#C77D3E', title: 'Hericium Rex — грибные БАД', desc: 'Интернет-магазин с корзиной, протоколами приёма и доставкой.' },
                            { href: '/cases/mozart-club/', img: '/images/cases/mozart-club/hero-mobile.jpg', scroll: '/images/cases/mozart-club/scroll.jpg', scrollH: 2192, accent: '#E11D2A', title: 'Mozart Club — запчасти', desc: 'Лендинг клубных карт: тарифы, сравнение цен, WhatsApp.' },
                            { href: '/cases/on-time-service/', img: '/images/cases/on-time-service/hero-mobile.jpg', scroll: '/images/cases/on-time-service/scroll.jpg', scrollH: 1504, accent: '#E0A126', title: 'On Time Service — логистика', desc: 'Сайт грузоперевозок: 8 услуг, калькулятор, SEO по регионам.' },
                        ].map((c) => (
