...
export const metadata: Metadata = {
    title: 'SMM продвижение в Шымкенте — ведение соцсетей',
    ...
    alternates: { canonical: '/smm-prodvizhenie-shymkent', languages: { 'ru-KZ': '/smm-prodvizhenie-shymkent', 'kk-KZ': '/kk/smm-prodvizhenie-shymkent', 'x-default': '/smm-prodvizhenie-shymkent' } },
    openGraph: {
...
export default function SmmShymkentPage() {
    return (
        <ServicePageTemplate
            ...
            features={[
                { title: 'Контент-стратегия', description: 'Индивидуальный контент-план с учётом особенностей рынка Шымкента и юга Казахстана.', icon: icon('M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4') },
                ...
                { title: 'Таргет для Шымкента', description: 'Настройка рекламы с таргетингом по геолокации Шымкента и Туркестанской области.', icon: icon('M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z') },
            ...
            process={[
                { step: '01', title: 'Анализ', description: 'Изучаем ваш бизнес, аудиторию в Шымкенте, конкурентов.' },
            ...
            faq={[
                { q: 'Вы находитесь в Шымкенте?', a: 'Наш офис — в Алматы, но мы работаем с клиентами по всему Казахстану удалённо. Для фотосъёмок в Шымкенте привлекаем локальных фотографов.' },
            ...
            seoContent={[
                {
                    title: 'SMM продвижение в Шымкенте — профессиональное ведение соцсетей',
                    text: <>
