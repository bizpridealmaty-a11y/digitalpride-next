...
export const metadata: Metadata = {
  ...
  description: "Digital Pride: работаем с социальными сетями, запускаем эффективные рекламные кампании, разрабатываем сайты и выводим их в топ поисковых систем",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="ru">
      <head>
        <link href="https://fonts.googleapis.com/css2?family=Dela+Gothic+One&family=Montserrat:wght@400;500;600;700;800&display=swap" rel="stylesheet" />
