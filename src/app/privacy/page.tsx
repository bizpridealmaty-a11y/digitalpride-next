                ...
                <article className="container mx-auto px-4 max-w-3xl">
                    ...
                    <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
                        ...
                        <section>
                            ...
                            <p>Также автоматически собирается обезличенная техническая информация через системы аналитики (Yandex.Metrika, Meta Pixel): IP-адрес, тип устройства, браузер, источник перехода, страницы посещения, время на сайте.</p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>На сайте используются cookies и системы аналитики (Yandex.Metrika, Meta Pixel) для улучшения работы сервиса. Вы можете отключить cookies в настройках вашего браузера, однако это может повлиять на работу некоторых функций сайта.</p>
                        </section>
