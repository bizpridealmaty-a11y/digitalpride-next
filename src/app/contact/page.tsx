...
<section class="section-contacts pt-5 pb-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-sm-5 col-md-4">
                <div class=""><br><br>
                    ...
                    <table cellpadding="5" cellspacing="1" class="table-contact">
	<tbody>
		<tr>
			<td>&nbsp;</td>
			<td>г. Алматы, ​Бульвар Бухар жырау, 33, офис 40</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><b><a href="tel:+77070357777">+77070357777</a></b></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><b><a href="mailto:digitalpride.almaty@gmail.com">digitalpride.almaty@gmail.com</a></b></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td><a href="https://www.instagram.com/digital.pride.smm/" target="_blank">Инстаграм https://www.instagram.com/digital.pride.smm/</a></td>
		</tr>
	</tbody>
</table>
            ...
            <div class="col-12 col-sm-7 col-md-8 p-0 p-sm-3">
    ...
    ymaps.ready(function () {
        ...
        if(\$('#map').length > 0 ){
            var myMap = new ymaps.Map('map', {
                    center: [43.23283457451145,76.92237849999998],
                    zoom: 16,
                    controls: []
                }, {
...
<section class="main-form form-bottom" id="modal_form-feedback">
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-6">
                <div class="main-form_title">Ответим на все ваши вопросы по нашей услугам</div>
                <p class="main-form_text">По всем вопросам, связанным с услугами,
                    ценами, оплатой и прочее, вы можете обращаться
...
<form class="ajax_form af_example form-main aj_form" method="post">
	...
	<input type="hidden" name="af_action" value="3a98b174708ab9c5e632ae59a0e3c960">
</form>                         
            </div>
        </div>
    </div>
