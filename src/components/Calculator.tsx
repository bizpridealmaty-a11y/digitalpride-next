...
const services: Service[] = [
    ...
    { id: 'target', label: 'Таргетированная реклама', price: 150000, note: 'без рекламного бюджета', group: 'Платные каналы' },
    { id: 'context', label: 'Контекстная реклама (Google + Яндекс)', price: 180000, note: 'без рекламного бюджета', group: 'Платные каналы' },
    { id: 'seo', label: 'SEO-продвижение', price: 350000, group: 'Платные каналы' },
    { id: 'audit', label: 'Аудит текущей рекламы', price: 0, note: 'бесплатно', group: 'Дополнительно' },
    { id: 'landing', label: 'Лендинг (одностраничный сайт)', price: 350000, note: 'единоразово', group: 'Сайт' },
    { id: 'corporate', label: 'Корпоративный сайт', price: 900000, note: 'единоразово', group: 'Сайт' },
    { id: 'shop', label: 'Интернет-магазин', price: 1700000, note: 'единоразово', group: 'Сайт' },
    { id: 'strategy', label: 'Маркетинговая стратегия', price: 250000, note: 'единоразово', group: 'Стратегия' },
    ...
    { id: 'brand', label: 'Фирменный стиль и брендбук', price: 350000, note: 'единоразово', group: 'Дополнительно' },
    { id: 'serm', label: 'Управление репутацией (SERM)', price: 130000, group: 'Дополнительно' },
    { id: 'bitrix', label: 'Внедрение Bitrix24', price: 280000, note: 'единоразово, далее 80 000/мес', group: 'Дополнительно' },
];
