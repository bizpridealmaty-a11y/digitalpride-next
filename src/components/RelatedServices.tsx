...
const ALL: Related[] = [
    ...
    { href: '/bitrix24', title: 'Внедрение Bitrix24', description: 'CRM, автоматизация воронки продаж.' },
...
const RELATIONS: Record<string, string[]> = {
    ...
    '/voronka-prodazh-almaty': ['/marketing-almaty', '/lending-almaty', '/bitrix24', '/perfomans-marketing'],
    '/audit-reklamy': ['/target-almaty', '/kontekstnaya-reklama-almaty', '/marketing-consulting-almaty', '/perfomans-marketing'],
    '/bitrix24': ['/voronka-prodazh-almaty', '/marketing-almaty', '/marketing-consulting-almaty', '/vneshnij-otdel-marketinga'],
