...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Удалённые/переименованные кейсы
      { source: '/cases/miele', destination: '/cases/hacker/', permanent: true },
      { source: '/cases/miele/', destination: '/cases/hacker/', permanent: true },
      { source: '/cases/dental-smile', destination: '/cases/', permanent: true },
      { source: '/cases/dental-smile/', destination: '/cases/', permanent: true },
      { source: '/cases/alma-flowers', destination: '/cases/', permanent: true },
      { source: '/cases/alma-flowers/', destination: '/cases/', permanent: true },
      { source: '/cases/kazlogistics', destination: '/cases/', permanent: true },
      { source: '/cases/kazlogistics/', destination: '/cases/', permanent: true },
      { source: '/cases/beauty-lab', destination: '/cases/', permanent: true },
      { source: '/cases/beauty-lab/', destination: '/cases/', permanent: true },
      { source: '/cases/technodom-partner', destination: '/cases/', permanent: true },
      { source: '/cases/technodom-partner/', destination: '/cases/', permanent: true },
      { source: '/cases/arman-group', destination: '/cases/', permanent: true },
      { source: '/cases/arman-group/', destination: '/cases/', permanent: true },
      { source: '/cases/silk-way-travel', destination: '/cases/', permanent: true },
      { source: '/cases/silk-way-travel/', destination: '/cases/', permanent: true },
